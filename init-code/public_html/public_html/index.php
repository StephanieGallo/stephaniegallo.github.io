          ...
          <div class="container">
            <div class="row vertical-align">
              <div class="col-sm-8 col-sm-offset-2">
                <h1 class="text-center"><strong>Riot</strong>, break free from authority...</h1>
                <h2 class="text-center">...one message at a time.</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="slider featured-slider">
            ...
            <div class="slide row section-table">
              <div class="col-sm-4 text-center"><img height= "550px" width="370px" src="images/screen2.png" class="img-responsive">
              </div>
              <div class="col-sm-8">
      ...
      <section class="section bg-primary">
        ...
        <div class="container">
          ...
          <div class="row features">
            ...
            <!-- 313x653-->
            <div class="col-sm-4 text-center wow pulse"><img height="653" width="313"src="images/screen1.png" alt="Screenshot 1" class="img-responsive">
            </div>
            <div class="col-sm-4">
