...
<body id="page-top" class="index">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Co-founders James and Aaron discuss inventing a snake habitat.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="img/about/initcode.png" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>June 2015</h4>
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Init Code is born and programming for Riot Messenger begins.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>January 2016</h4>
                                    <h4 class="subheading">Riot Messenger Launches</h4>
                                </div>
                                <div class="timeline-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Meet our the people behind Init Code and Riot Messenger</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>Angelo Aquino</h4>
                        <p class="text-muted">Senior Frontend Engineer</p>
                        <ul class="list-inline social-buttons">
                            <!--<li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
    ...
    <section id="join">
        <div class="container">
            ...
            <p>Etiam sodales orci at urna rutrum, et aliquet mi bibendum. Suspendisse porttitor nec lorem id eleifend. Cras nulla mauris, vulputate in lacinia eu, tincidunt eget ligula. Fusce finibus in nisi non dapibus. Aliquam semper molestie erat, id efficitur neque fermentum vitae. Sed eget risus sit amet nunc placerat bibendum ut semper urna. Aliquam erat volutpat.</p>
            ...
            <div class="row text-center">
                <div class="col-md-6">
                    ...
                    <h4 class="service-heading">Developers</h4>
                    <p class="text-muted">Open Positions for: <br>Senior IOS Devs<br>IOS UIX Devs<br>IOS Networking Devs<br>Android UIX Devd<br>Android Networking Devs<br>Backend Engineer<br>End Point Security Architect</p>
                </div>
                <div class="col-md-6">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Marketing and Administration</h4>
                    <p class="text-muted">Open Positions for:<br> Systems Administrator<br>Growth Specialist<br>Senior Mobile Marketing Manager </p>
                </div>
                <!--<div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                        <i class="fa fa-file-picture-o fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="service-heading">Graphic Designers</h4>
          ...
          ?>
            <div class="row">
                <div class="col-lg-12 text-center">
                   ...
                   <!--<h3 class="section-subheading text-muted">If you would like to get in touch with Init Code regarding a job or investing, please contact us below.</h3>-->
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
