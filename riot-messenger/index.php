    ...
    if(!$error)
    {
      ...
      catch(PDOException $e)
      {
        ...
        $header = 'From BetaUser <' . $_POST["email"] . '>' . "\r\n" .
          ...
          $betaSent = mail("info@riot-messenger.com", "New beta user!", $message, $header);

          $beta = true;
            $header = 'From info@riot-messenger.com';
            $message = "Welcome to Riot Messenger Beta!
                         We're excited to Riot with you.
                         Beta is set to launch on October 31st, 2015.
                         When we're ready, we'll send you a special code and download link for the Riot App.

                          Thank you,
                          The Riot Messenger Team";
          $betaSent = mail($_POST["email"], "Are you ready to Riot?", $message, $header);
          ...
          <nav class="nav">
            ...
            <ul class="list-inline pull-right">
             <li><a href="#UI" class="smooth-scrolling">What is Riot?</a></li>
              ...
              <li><a href="http://blog.riot-messenger.com/" target="new">Blog</a></li>
      ...
      <header id="home" class="header">
       <!-- Header begin-->
        <div class="header-section">
            <div id="riot-hlogo"><img src="images/riot-logo.png" ></div>
            <canvas id="sky" style="position: absolute; z-index: 1;"></canvas>
          <div class="container"> 
            <div class="row vertical-align">
              <div class="col-sm-8 col-sm-offset-2">
                
                <h1 class="text-center" id="header-text">Communicate <em style="color:#646464">securely</em><br>without using data or internet</h1>
                <h2 class="text-center"> 
                  <a href="#beta" class="smooth-scrolling">
                    <button type="button" class="btn btn-primary btn-lg">Join Now!</button></a></h2>
          ...
          <div class="row text-center">
           <div class="col-xs-12 col-sm-4 wow bounceInUp"><span class="huge-icon fa fa-globe text-primary"></span>
            ...
            <ul class="list-inline social-buttons red text-center">
                        ...
                        <li>
                          <a href="http://blog.riot-messenger.com/" target="_blank"><i class="fa fa-tumblr"></i></a>
                        </li>
            </ul>
            </div>
